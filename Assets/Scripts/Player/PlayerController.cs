...
public class PlayerController : NetworkBehaviour, IPlayerActions
{
    ...
    public NetworkVariable<int> currentAmmo = new NetworkVariable<int>(10, NetworkVariableReadPermission.Everyone,
    ...
    [SerializeField] private Sprite shipIdle, shipMoving;
